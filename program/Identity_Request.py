from program.common import convert_to_readable, get_tshark_output,identity_mapping_name, prompt_creator
...
def identity_request_part(factor_to_consider, uplink_command, downlink_command ,response, pcap_file_path,dl_com_invoke_line, renamed_pcap_text,llm_type):
